...
public class MainViewTests {
	...
	private List<Contact> getCustomersInGrid() {
		ListDataProvider<Contact> ldp = (ListDataProvider) mainView.grid.getDataProvider();
	...
	public void shouldMakeEditorVisible() {
		Contact first = getCustomersInGrid().get(0);
	...
	static class Config {
		...
		public void initializeData() {
			this.repository.save(new Contact("Jack", "Bauer"));
			this.repository.save(new Contact("Chloe", "O'Brian"));
			this.repository.save(new Contact("Kim", "Bauer"));
			this.repository.save(new Contact("David", "Palmer"));
			this.repository.save(new Contact("Michelle", "Dessler"));
		}
	}
}
